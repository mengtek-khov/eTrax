...
from etrax.core.telegram import LoadCallbackConfig, LoadCallbackModule


def resolve_callback_module_step_config(
    *,
    bot_id: str,
    route_label: str,
    step: dict[str, Any],
...
def build_callback_module_step(
    *,
    step_config: LoadCallbackConfig,
    ...
    return LoadCallbackModule(config=step_config)


RUNTIME_MODULE_SPEC = {
    "module_type": "callback_module",
    "config_type": LoadCallbackConfig,
    "resolve_step_config": resolve_callback_module_step_config,
    "build_step_module": build_callback_module_step,
}
